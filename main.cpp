...
string Playfair_Encode(string origin, string key)
{
    int i,j,k,n;
    string s;
...
string Playfair_Decode(string cipher_text, string key)
{
    int i,j,k,n;
    string s;
...
string Vigenere_Encode(string plaintext, string key)
{
    ...
    for(int i = 0; i < plaintext.length(); i++)
    {
        ...
        int plainCode = (int)plainChar - 65;
        int keyCode = (int)keyChar - 65;
        // add the two codes and wrap around
        int cipherCode = (plainCode + keyCode) % 26;
        // convert cipher code back to character
        char cipherChar = (char)(cipherCode + 65);
...
string vigenere_Decode(string ciphertext, string keyword)
{
...
int main()
{
    cout<<"Choose any algorithm from the list to Encode OR Decode the message ..."<<endl;
    cout << "Enter 1 To Used Caesar_Encode : " << endl;
    cout << "Enter 2 To Used Caesar_Decode : " << endl;
    cout << "Enter 3 To Used Vigenere_Encode : " << endl;
    cout << "Enter 4 To Used vigenere_Decode : " << endl;
    cout << "Enter 5 To Used Playfair_Encode : " << endl;
    cout << "Enter 6 To Used Playfair_Decode : " << endl;
    cout << "Enter 7 To Used DES : " << endl;
    int num;
    cin >> num;
    cin.ignore();
    switch (num)
    ...
    case 7:
    {
        ...
        cout << "Enter Plain Text of 16 character written in hex: ";
        do
        {
            is_valid = true;
            cin >> plain_txt;
        ...
        while (!is_valid);
        cout << "Enter a Key of 16 character written in hex: ";
        do
        {
            is_valid = true;
            cin >> key;
    ...
    default:
        cout << "Please enter a correct num." << endl;
        break;
    }
    return 0;
}
